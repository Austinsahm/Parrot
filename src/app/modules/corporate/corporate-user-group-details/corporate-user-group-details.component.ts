...
@Component({
  selector: "app-corporate-user-group-details",
  templateUrl: "./corporate-user-group-details.component.html",
  styleUrls: ["./corporate-user-group-details.component.scss"],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CorporateUserGroupDetailsComponent implements OnInit {
  formColor: string;
  formBgColor: string;
  formFont: string;
  ...
  ngOnInit(): void {
    this.source$ = this.route.paramMap.pipe(
      concatMap((params) => this._resolve(params.get("group"))),
