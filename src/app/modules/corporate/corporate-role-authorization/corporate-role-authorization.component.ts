...
@Component({
  selector: "app-corporate-role-authorization",
  templateUrl: "./corporate-role-authorization.component.html",
  styleUrls: ["./corporate-role-authorization.component.scss"],
})
export class CorporateRoleAuthorizationComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    console.log(this.userId, this.subdomain, this.companyName);
  }
