...
@Component({
  selector: 'app-company-billing-list',
  templateUrl: './company-billing-list.component.html',
  styleUrls: ['./company-billing-list.component.scss']
})

export class CompanyBillingListComponent implements OnInit, OnDestroy {
  ...
  openDetails(company:Company): void {
    this.router.navigate(
      [`../company-billing-form/${company.companyId}/company/${company.companyName.trim()}`],
      {
