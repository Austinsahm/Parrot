...
@Component({
  selector: "app-device-summary-data-detail",
  templateUrl: "./device-summary-data-detail.component.html",
  styleUrls: ["./device-summary-data-detail.component.scss"],
})
export class DeviceSummaryDataDetailComponent implements OnInit {
  ...
  lastStatus() {
    this.dashboard
      .latestDeviceLog(this.device.deviceId)
